...
Although both categories include a number of **outliers**, the non-meat category has a very dense set outliers suggesting there are some non-meat recipes providing extremely protein dense options. 
